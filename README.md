...
This is a Dockerfile for Shiny Server on Debian "jessie". It is based on the ca3tech/r-ver image.

The image is available from [Docker Hub](https://hub.docker.com/r/ca3tech/shiny/).
...
```sh
docker run --rm -p 3838:3838 ca3tech/shiny
```
